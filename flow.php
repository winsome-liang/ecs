...
//    die(sprintf($_LANG['bonus_is_ok'], price_format($bonus['type_money'], false)));
    ...
    else
    {
		...
		file_put_contents("aa.txt", json_encode($order),FILE_APPEND);
        ...
        /* 计算订单的费用 */
        $total = order_fee($order, $cart_goods, $consignee);
        file_put_contents("aa.txt", json_encode($total),FILE_APPEND);
        file_put_contents("aa.txt", json_encode($bonus),FILE_APPEND);
