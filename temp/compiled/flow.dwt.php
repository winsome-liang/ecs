...
?>
        ...
        <?php $_from = $this->_var['consignee_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('sn', 'consignee_0_84606700_1389116157');if (count($_from)):
    foreach ($_from AS $this->_var['sn'] => $this->_var['consignee_0_84606700_1389116157']):
?>
...
?>
    ...
    foreach ($_from AS $this->_var['bonus']):
?>
      <?php if ($this->_var['bonus']['send_type'] == 5): ?>
      <option value="<?php echo $this->_var['bonus']['bonus_id']; ?>" <?php if ($this->_var['order']['bonus_id'] == $this->_var['bonus']['bonus_id']): ?>selected<?php endif; ?>><?php echo $this->_var['bonus']['type_name']; ?>[享受折扣 <?php echo $this->_var['bonus']['type_money']; ?>%]</option>
      <?php else: ?>
       <option value="<?php echo $this->_var['bonus']['bonus_id']; ?>" <?php if ($this->_var['order']['bonus_id'] == $this->_var['bonus']['bonus_id']): ?>selected<?php endif; ?>><?php echo $this->_var['bonus']['type_name']; ?>[<?php echo $this->_var['bonus']['bonus_money_formated']; ?>]</option>
       <?php endif; ?>
