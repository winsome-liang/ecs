...
<table width="100%">
  ...
  <tr>
    ...
    <td>
      ...
      <input type="radio" name="send_type" value="4" <?php if ($this->_var['bonus_arr']['send_type'] == 4): ?> checked="true" <?php endif; ?> onClick="showunit(4)"  />注册发放  
   <input type="radio" name="send_type" value="5" <?php if ($this->_var['bonus_arr']['send_type'] == 5): ?> checked="true" <?php endif; ?> onClick="showunit(5)"  />折扣红包   </td>
      </td>
  </tr>
